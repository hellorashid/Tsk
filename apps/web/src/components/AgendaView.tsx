  ...
  return (
    <div
      className={`w-full h-full overflow-y-auto flex flex-col ${
        ...
        style={{ 
        backgroundColor: framed ? getGlassSurface(accentColor, isDarkMode) : 'transparent',
        scrollbarWidth: 'none',
      ...
      <div className="p-5 pb-32 md:pb-8 space-y-4">
        ...
        <div className={`rounded-2xl p-5 border transition-colors ${cardBg} ${cardBorder}`}>
          <p className={`text-lg leading-relaxed ${isDarkMode ? 'text-gray-200' : 'text-gray-700'}`}>
            ...
            {' '}
            <TaskCountSummary taskIds={scheduledTaskIds} eventCount={eventCount} />
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
            ...
            {weatherEvent?.metadata?.weather ? (
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-1.5">
                    <p className="text-2xl font-bold">{weatherEvent.metadata.weather.temperature}°</p>
                    ...
                    <div className="flex items-center gap-2.5 mt-0.5">
                      {weatherEvent.metadata.weather.sunrise && (
                        <div className="flex items-center gap-1">
                          <svg className={`w-3 h-3 ${isDarkMode ? 'text-orange-400' : 'text-orange-500'}`} viewBox="0 0 24 24" fill="currentColor">
                      ...
                      {weatherEvent.metadata.weather.sunset && (
                        <div className="flex items-center gap-1">
                          <svg className={`w-3 h-3 ${isDarkMode ? 'text-indigo-400' : 'text-indigo-500'}`} viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className={`text-xs ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>No data</p>
                </div>
              </div>
            )}
                </div>
          ...
          {/* Up Next Widget */}
          <div 
            className={`rounded-2xl p-3 border transition-colors cursor-pointer ${cardBg} ${cardBorder}`}
