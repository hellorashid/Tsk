                    ...
                    <div className="space-y-4">
                        ...
                        <div className="border-t border-white/10 pt-2">
                            <h6 className="font-mono text-sm mb-2">
                                built by: <a target="_blank" rel="noreferrer" href="https://twitter.com/_ingriddsss" className="hover:underline">@_ingriddsss</a> & <a target="_blank" rel="noreferrer" href="https://twitter.com/razberrychai" className="hover:underline">@razberrychai</a>
                            </h6>
                            <p className="text-sm opacity-80">we would love to hear your feedback!</p>
                        </div>
                    </div>
            </div>
        </div>
