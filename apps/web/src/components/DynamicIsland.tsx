...
interface DynamicIslandProps {
  ...
  onUpdateTask: (id: string, changes: TaskUpdate) => void;
  onDeleteTask: (id: string) => void;
  onUpdateEvent?: (id: string, changes: ScheduleCardUpdate) => void;
...
const DynamicIsland: React.FC<DynamicIslandProps> = ({
  ...
  const tasksFolderCommand = showOtherFolder ? [{
    id: 'folder-other',
  ...
  const todayFolderCommand = showTodayFolder ? [{
    id: 'folder-today',
  ...
  const closeExpandedIsland = useCallback(() => {
    ...
    setEventStartTime('');
    setEventEndTime('');
  }, [currentEvent, onEventSelect, onTaskSelect, onUpdateEvent, onUpdateTask, selectedTask]);
  ...
  }, [closeExpandedIsland, isExpanded, onModeChange]);
  ...
  const handleEventDescriptionKeyDown = (e: React.KeyboardEvent<HTMLTextAreaElement>) => {
    ...
    // The global handler calls closeExpandedIsland, so this stays a no-op for Escape-specific reset logic.
